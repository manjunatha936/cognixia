...
<div class="wrap">
	...
	<form method="post" action="settings.php" novalidate="novalidate">
		...
		<table class="form-table" role="presentation">
			<tr>
				<th scope="row">
					<?php _e('Allow new registrations'); ?>
				</th>
				<?php
				...
				<td>
					<fieldset>
						<legend class="screen-reader-text">
							<?php _e('New registrations settings'); ?>
						</legend>
			...
			<tr>
				<th scope="row">
					<?php _e('Registration notification'); ?>
				</th>
				<?php
				...
				<td>
					<label><input name="registrationnotification" type="checkbox" id="registrationnotification"
							value="yes" <?php checked(get_site_option('registrationnotification'), 'yes'); ?> />
						<?php _e('Send the network admin an email notification every time someone registers a site or user account'); ?></label>
				</td>
			</tr>

			<tr id="addnewusers">
				<th scope="row">
					<?php _e('Add New Users'); ?>
				</th>
				<td>
			...
			<tr>
				<th scope="row"><label for="limited_email_domains">
						<?php _e('Limited Email Registrations'); ?>
					</label></th>
				<td>
					<?php
...
<?php echo esc_textarea(get_site_option('first_comment')); ?></textarea>
		...
		if (!empty($languages) || !empty($translations)) {
			...
			<table class="form-table" role="presentation">
				<tr>
					<th><label for="WPLANG">
							<?php _e('Default Language'); ?><span class="dashicons dashicons-translation"
		...
		if ($menu_items):
			...
			<table id="menu" class="form-table">
				<tr>
					<th scope="row">
						<?php _e('Enable administration menus'); ?>
					</th>
					<td>
						<?php
