        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <section class="cog-banner cog-bg-info">
                <div class="cog-banner__figwrap ms-auto">
                    <img class="cog-img-blendmode cogximg650" src="<?php echo get_field('banner_section_image'); ?>" alt="Banner" />
                </div>
                ...
                <div class="cog-banner-content cog-vr-flexcenter">
                    <div class="container cog-banner-content__container">
                        <div class="row">
                            <div class="col-12 col-lg-7 col-xl-5 me-auto offset-lg-1">
            ...
            <section class="section-padding100">
                <div class="container">
                    <div class="col-md-8 mx-auto text-center mb-md-5 pb-md-4">
                        <h3 class="h3 fw-bold mb-2 mb-md-4"><?php echo get_field('organization_transformation_headinh'); ?></h3>
                        <p class="cog-lead">
                        <?php echo get_field('organization_transformation_description'); ?>
                        </p>
                    </div>
                    <div class="row position-relative pb-md-5">
                        <div
                            class="swiper TransformationSlider text-center swiper-initialized swiper-horizontal swiper-backface-hidden">
                            <div class="swiper-wrapper" id="swiper-wrapper-a215877d806e2843" aria-live="polite"
                                style="cursor: grab">
                                <?php if (have_rows('organization_transformation__repeater')):
                                    while (have_rows('organization_transformation__repeater')):
                                        the_row(); ?>
                                <div class="swiper-slide swiper-slide-active" role="group" aria-label="1 / 4"
                                    style="width: 394.688px; margin-right: 15px">
                                    <div class="cog-card cog-card--pri">
                                        <div class="cog-card-pattern">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/img/patterns/logo-transparent.svg" alt="logo pattern" />
                                        </div>
                                        <div class="cog-card__body cog-flexcenter p-0">
                                            <h4 class="fw-normal fs-32">
                                                <?php echo get_sub_field('organization_transformation_heading'); ?>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div
                            class="swiper-pagination cog-pagination-btm d-block d-md-none swiper-pagination-bullets swiper-pagination-horizontal">
                            <span class="swiper-pagination-bullet swiper-pagination-bullet-active"
                                aria-current="true"></span><span class="swiper-pagination-bullet"></span>
                        </div>
                        <!-- Swiper paginatin arrows-->
                        <div class="cog-arrows-container">
                            <div class="cog-btn-circle swiper-button-prev swiper-button-disabled" tabindex="-1"
                                role="button" aria-label="Previous slide"
                                aria-controls="swiper-wrapper-a215877d806e2843" aria-disabled="true">
                                <svg class="cog-icon-arrow" width="16" height="16" viewBox="0 0 16 16" fill="none"
                            ...
                            <div class="cog-btn-circle swiper-button-next" tabindex="0" role="button"
                                aria-label="Next slide" aria-controls="swiper-wrapper-a215877d806e2843"
                                aria-disabled="false">
                                <svg class="cog-icon-arrow" width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
